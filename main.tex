...
\titulo{
  \lang
  {Development of a web based visualization tool\protect\\for digital manufacturing processes}
  {Desenvolvimento de ferramenta de visualização para\protect\\processos de manufatura digital na web}
}
